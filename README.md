...
1. ssh to your VPS
2. write `bash <(wget -qO- https://raw.githubusercontent.com/rafaeldelrey/ns-setup/main/ns-setup.sh)` in console, press enter and follow installation instructions.
